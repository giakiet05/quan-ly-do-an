# ✅ DTOs & Models - Complete Checklist
...
| `Classroom`              | `Classroom`              | ✅ Done |
| `ClassroomSetting`       | `ClassroomSetting`       | ✅ Done |
| `Group`                  | `Group`                  | ✅ Done |
| `Task`                   | `Task`                   | ✅ Done |
| `Report`                 | `Report`                 | ✅ Done |
| `ReportFeedback`         | `ReportFeedback`         | ✅ Done |
| `GroupSetting`           | `GroupSetting`           | ✅ Done |
| `JoinGroupRequest`       | `JoinGroupRequest`       | ✅ Done |
...
| `group_dto.go`                | `group-dto.ts`                | ✅ Done    |
